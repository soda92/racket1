            ...
            >
                ...
                <img
                  ...
                  className={`w-full h-full object-cover transition-all duration-700 ${
                    state
                      ...
                      : "grayscale blur-[2px] scale-105 opacity-50"
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <span className="text-[8px] font-black uppercase tracking-widest text-slate-500">
                      Level {index + 1} •{" "}
                      {level.defaultSize.cols}x{level.defaultSize.rows}
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  {state ? "Replay Puzzle" : "Solve Puzzle"}
                </button>
              </div>
            </motion.div>
          );
        ...
        <div className="p-6 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium">
              Download this gallery to solve puzzles even without an internet
              connection.
            </p>
          </div>
        </div>
